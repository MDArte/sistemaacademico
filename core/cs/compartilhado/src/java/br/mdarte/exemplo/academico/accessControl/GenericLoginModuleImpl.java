...
public class GenericLoginModuleImpl extends GenericLoginModule {
	...
	/**
	 * @see br.mdarte.exemplo.academico.accessControl.GenericLoginModule#handleInitialize(javax.security.auth.Subject, javax.security.auth.callback.CallbackHandler, java.util.Map, java.util.Map)
	 */
