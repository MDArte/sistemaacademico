...
<script type="text/javascript" language="Javascript1.1" src="/sistemaacademico/layout/${layout}/javaScripts/jquery.validate.js"></script>
...
<script type="text/javascript" language="Javascript1.1" charset="utf-8" src="/sistemaacademico/layout/${layout}/javaScripts/codemirror.js"></script>
<script type="text/javascript" language="Javascript1.1" src="/sistemaacademico/layout/${layout}/javaScripts/tinymce/js/tinymce/tinymce.min.js"></script>
<script type="text/javascript" language="Javascript1.1" src="/sistemaacademico/layout/${layout}/javaScripts/jquery.mask.min.js"></script>
<script type="text/javascript" language="Javascript1.1" src="/sistemaacademico/layout/${layout}/javaScripts/jquery.validate.min.js"></script>
<script type="text/javascript" language="Javascript1.1" src="/sistemaacademico/layout/${layout}/javaScripts/additional-methods.min.js"></script>
<script type="text/javascript" language="Javascript1.1" src="/sistemaacademico/layout/${layout}/javaScripts/jquery-ui.min.js"></script>
<script type="text/javascript" language="Javascript1.1" src="/sistemaacademico/layout/${layout}/javaScripts/jquery.jtable.min.js" type="text/javascript"></script>
<script type="text/javascript" language="Javascript1.1" src="/sistemaacademico/layout/${layout}/javaScripts/typeahead.min.js"></script>
